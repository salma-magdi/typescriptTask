import { SignupObject, SigninObject, ValidationResult } from './types';
...
export const validateSignup = (data: SignupObject): ValidationResult => {
...
export const validateSignin = (data: SigninObject): ValidationResult => {
    const errors: Record<string, string> = {};
